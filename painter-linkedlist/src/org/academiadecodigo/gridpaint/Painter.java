...
import org.academiadecodigo.gridpaint.iomechanics.Saver;
...
public class Painter implements KeyboardHandler {
    ...
    //Text requiring global scope
    private Text text7;
    public static Text message;
    public static Text warning;

    public Painter(double cellSize) {
        this.warning = new Text(BORDER,BORDER,"");
        this.cellSize = cellSize;
        this.slot = 0;
    }

    public void init() {
        table = new Rectangle(BORDER, BORDER, 1200, 900);
        ...
        Text text5 = new Text(text4.getX(), text4.getY() + 40, "P - Exit, R - Recenter pointer, F - Fill");
        Text text6 = new Text(text5.getX(), text5.getY() + 40, "B - Increase slot, N - Decrease slot");
    ...
    private void save() {
        ...
        saver.saveSlot(slot);
        saver.saveData(grid.getListOfCells());
    }

    private void load() {
        Saver saver = new Saver();
        saver.saveSlot(slot);
        saver.loadData(grid.getListOfCells());
    }
